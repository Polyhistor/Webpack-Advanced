!(function(e) {
  function t(t) {
    for (var n, r, u = t[0], a = t[1], i = 0, l = []; i < u.length; i++)
      (r = u[i]),
        ...
        t.push(
          (r[e] = new Promise(function(t, n) {
            for (
              ...
              var c =
                (s = i[l]).getAttribute("data-href") || s.getAttribute("href");
              if ("stylesheet" === s.rel && (c === o || c === a)) return t();
            }
            var f = document.getElementsByTagName("style");
            for (l = 0; l < f.length; l++) {
              var s;
              if ((c = (s = f[l]).getAttribute("data-href")) === o || c === a)
                return t();
            }
